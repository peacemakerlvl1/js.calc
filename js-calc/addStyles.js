const bodyClass = "bg-orange 500 bg-gradient-to-br from-blue-800 bg-opacity-29";
...
function addClasses(button) {
  const btnNumberClass = "hover:bg-white-500 border-red-500";
  const btnClearClass = "hover:bg-orange-500 border-red-500";
  const btnOpClass = "hover:bg-yellow-500 border-yellow-500";
